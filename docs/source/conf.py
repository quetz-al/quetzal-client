...
htmlhelp_basename = 'QuetzalPythonClientdoc'
...
latex_documents = [
    (master_doc, 'QuetzalPythonClient.tex', 'Quetzal Python Client Documentation',
     'David Ojeda', 'manual'),
]
...
man_pages = [
    (master_doc, 'quetzalpythonclient', 'Quetzal Python Client Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'QuetzalPythonClient', 'Quetzal Python Client Documentation',
     author, 'QuetzalPythonClient', 'One line description of project.',
     'Miscellaneous'),
]
